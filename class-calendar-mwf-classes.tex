...
\item The aim is to build a reasonably paced course calendar that
be followed without attempting to rush through last handful of
sections. 
...
\item We hope use this textbook and course calendar for the Academic years 2023--2024 and 2024--2025.
...
\item This calendar has four midterm examinations and weekly homework 
 assignments, but instructors are free to modify the course assessments.

 \item The La\TeX\/, code does automatic date arithmetic. Also,
 given the time of the class, it finds the correct day for the
 final exam.
...
\mweek{2.1}{Linear Functions}{\hw}
\eweek{2.2}{Absolute Value Functions}{}
% Week 4
\nweek{1.1---2.2}{\review}{}
\mweek{}{\examday}{\ex}
\eweek{2.3}{Quadratic Functions}{}
 ...
 \mweek{2.4}{Inequalities with Absolute Value and Quadratic Functions}{\hw}
\eweek{3.1}{Graphs of Polynomials}{}
 % Week 6
\nweek{3.2}{The Factor Theorem and the Remainder Theorem}{}
\mweek{3.3}{Real Zeros of Polynomials}{\hw}
\eweek{4.1}{Introduction to Rational Functions}{}
%Week 7
\nweek{4.2}{Graphs of Rational Functions}{}
\mweek{4.3}{Rational Inequalities and Applications}{\hw}
\eweek{4.3}{Rational Inequalities and Applications}{}
% Week 8
...
\eweek{6.1}{Introduction to Exponential and Logarithmic Functions}{}
% Week 11 
\nweek{6.1}{Introduction to Exponential and Logarithmic Functions}{}
\mweek{6.2}{Properties of Logarithms}{\hw}
\eweek{6.2}{Properties of Logarithms}{}
% Week 12
\nweek{6.3}{Exponential Equations and Inequalities}{}
\mweek{6.4}{Logarithmic Equations and Inequalities}{\hw}
\eweek{5.1---6.4}{\review}{}
% Week 13
\nweek{}{\examday}{\ex}
...
\mweek{8.1}{Systems of Linear Equations: Gaussian Elimination}{\hw}
