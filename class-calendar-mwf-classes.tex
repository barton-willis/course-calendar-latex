\documentclass[10pt]{article} % 12 point doesn't fit on one page
...
\newcommand{\calendarHead}[2]{%
  ...
  \large
   \begin{flushleft}
    ...
    #1 #2 \\
    \emph{College Algebra} by Stitz and Zeager
  \end{flushleft}
  \normalsize}
...
% Week one
\nweek{1.1}{Sets of Numbers}{}
\mweek{1.2---1.3}{The Cartesian Coordinate Plane \& Distance in the Plane}{}
%\mweek{1.3}{Distance in the Plane}
...
\mweek{4.1}{Introduction to Rational Functions}{\hw}
...
\nweek{5.1---6.2}{\review}{}
\mweek{}{\examday}{\ex}
\eweek{6.3}{Exponential Equations and Inequalities}{}
% Week 12
